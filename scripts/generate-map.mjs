...
const lines = [
  ...
  '  Contributing["CONTRIBUTING.md issue and contribution workflow"]',
  '  RepoDocs["docs/index.md repo implementation notes"]',
  '  BrandDocs["docs/brand-assets.md favicon and logo rules"]',
  '  Favicon["public/brand/bapx-fav-icon.svg"]',
